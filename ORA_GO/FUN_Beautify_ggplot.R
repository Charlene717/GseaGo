BeautifyggPlot = function( P1,
                           LegPos = c(0.88, 0.2),LegBox = "vertical",LegDir="vertical",
                           LegTitleSize=18 ,LegTextSize = 15,
                           TH= 0.05,TV= 1, TitleSize = 25,
                           XtextSize=17,  YtextSize=20,  XaThick=1.2,  YaThick=1.2, xangle =0,
